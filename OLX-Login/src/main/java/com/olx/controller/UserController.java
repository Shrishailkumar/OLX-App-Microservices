...
public class UserController {
	...
	/*
	 * @PostMapping(value = "/user/authenticate") public void
	 * authenticatUser(@PathVariable("id") int id) {
	 * 
	 * }
	 */
	 ...
	 * //@ApiOperation(value="delete an user") public boolean
	 * deleteAdvertise(@RequestHeader("auth") String AuthToken) { return
	 * userDetailsService.logoutUser(AuthToken); }
	 */
